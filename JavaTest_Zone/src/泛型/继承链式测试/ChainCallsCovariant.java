...
public class ChainCallsCovariant {
    ...
    static class Layer1<T extends Layer1<T>> {
        public T layer1Method() {
            return (T) this;
        }
    }

    static class Layer2<T extends Layer2<T>> extends Layer1<T> {
    ...
    public static void main(String[] args) {
        Layer3.newLayer3Instance().layer1Method().layer2Method().layer3Method().layer2Method();
    }
}